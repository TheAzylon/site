$(document).ready(function(){
	...
	function gameover(){
		...
		for(i=0; i<=3; i++){
			for(j=0; j<=3; j++){
				if(numbers2[i][j]==2048){
					alert("Congratilations!")
					return;
				}
				if((i==0)&&(j==0)){
					if((numbers2[i][j]==numbers2[i+1][j])||(numbers2[i][j]==numbers2[i][j+1])){
					return;
				}
				}
				if((i==0)&&(j==3)){
				...
				if((i<=2)&&(j!=0)&&(j!=3)){
					if((numbers2[i][j]==numbers2[i+1][j])||(numbers2[i][j]==numbers2[i][j+1])||(numbers2[i][j]==numbers2[i][j-1])){
						return;
					}
				}
				if((i==3)&&((j==1)||(j==2))){
				...
				if((j<=2)&&(i!=0)&&(i!=3)){
					if((numbers2[i][j]==numbers2[i][j+1])||(numbers2[i][j]==numbers2[i+1][j])||(numbers2[i][j]==numbers2[i-1][j])){
						return;
					}
				}
				if((j==3)&&((i==1)||(i==2))){
